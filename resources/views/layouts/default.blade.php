...
<link href="https://fonts.googleapis.com/css2?family=Delius&display=swap" rel="stylesheet">
    ...
    <body>
        <div class="banner">
            <p>WE ARE OPEN </p>    
            <p>Vous pouvez continuer de profiter de nos bons repas grâce au système
            de « click & collect » en limitant au maximun les risques liés au COVID-19.</p>
        </div>
        <ul class="nav align-items-center mb-2" style="padding: 10px">
            <li class="nav-item">
        ...
        <div class="footer">
            ...
            <p>© 2021, Food Booking powered by Laravel</p>
        </div>
    </body>
</html>